...
import android.exemple.com.mycarapplication.extras.UtilTCM;
...
public class CarFragment extends Fragment implements RecyclerViewOnClickListenerHack, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        // TRANSITIONS
           /* if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
                ...
                this.setEnterTransition( trans1 );
                this.setReturnTransition(trans2);
            }*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*GridLayoutManager llm = new GridLayoutManager(getActivity(), 3, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(llm);*/
        ...
        // SWIPE REFRESH LAYOUT
            ...
            public void onRefresh() {
                ...
                if (UtilTCM.verifyConnection( getActivity() )){
                    ...
                    android.support.design.widget.Snackbar.make(view, "Pas de connexion à Internet. S'il vous plaît vérifier votre wifi ou 3G.", android.support.design.widget.Snackbar.LENGTH_LONG)
                    ...
                    /*SnackbarManager.show(
                            Snackbar.with(getActivity())
                                    .text("Pas de connexion à Internet. S'il vous plaît vérifier votre wifi ou 3G.")
    ...
    public void setFloatingActionButton(View view){
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                android.support.design.widget.Snackbar.make(v, "FAB Clicked.", Snackbar.LENGTH_LONG)
                        .setAction("Ok", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
        ...
        int shadaw = (int)(3 * scale * 0.5);
        fab.setShadowRadius(shadaw);
    ...
    public void onClickListener(View view, int position) {
        ...
        i.putExtra("car", mList.get(position));
    ...
    public void onClick(View v) {
        ...
        /*switch (v.getId()){
            case R.id.fab1:
                aux = "Facebook pressed.";
                break;
            case R.id.fab2:
                aux = "Google Plus pressed.";
                break;
            case R.id.fab3:
                aux = "TouTube pressed.";
                break;
            case R.id.fab4:
                aux = "LinkedIn pressed.";
                break;
            case R.id.fab5:
                aux = "WhatsApp pressed.";
                break;
        }*/
